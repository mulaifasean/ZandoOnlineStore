...
public partial class KidsMain : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            price1.InnerText = "R" + dt.Rows[0]["Price"].ToString();//price
            mg1.ImageUrl = dt.Rows[0]["prod_image"].ToString();//image
            A1.HRef = "ProductDetails.aspx?Id=" + dt.Rows[0]["ProductId"].ToString();

            name2.InnerText = dt.Rows[1]["ProductName"].ToString();//name
            des2.InnerText = dt.Rows[1]["ProductDescription"].ToString();//desc
            price2.InnerText = "R" + dt.Rows[1]["Price"].ToString();//price
            mg2.ImageUrl = dt.Rows[1]["prod_image"].ToString();//image
            A2.HRef = "ProductDetails.aspx?Id=" + dt.Rows[1]["ProductId"].ToString();


            name3.InnerText = dt.Rows[2]["ProductName"].ToString();//name
            des3.InnerText = dt.Rows[2]["ProductDescription"].ToString();//desc
            price3.InnerText = "R" + dt.Rows[2]["Price"].ToString();//price
            mg3.ImageUrl = dt.Rows[2]["prod_image"].ToString();//image
            A3.HRef = "ProductDetails.aspx?Id=" + dt.Rows[2]["ProductId"].ToString();

            name4.InnerText = dt.Rows[3]["ProductName"].ToString();//name
            des4.InnerText = dt.Rows[3]["ProductDescription"].ToString();//desc
            price4.InnerText = "R" + dt.Rows[3]["Price"].ToString();//price
            mg4.ImageUrl = dt.Rows[3]["prod_image"].ToString();//image
            A4.HRef = "ProductDetails.aspx?Id=" + dt.Rows[3]["ProductId"].ToString();
